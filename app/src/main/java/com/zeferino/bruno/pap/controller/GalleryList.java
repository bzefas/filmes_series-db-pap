...
import com.zeferino.bruno.pap.adapter.GalleryAdapter;
import com.zeferino.bruno.pap.model.GalleryModel;
...
public class GalleryList extends Fragment implements AdapterView.OnItemClickListener {
    ...
    private void setGallery() {
        ...
        for (int i = 0; i < galleryPath.size(); i++) {
            ...
            gallery.setFilePath(Constants.imageUrl + getResources().getString(R.string.galleryImgSize) + galleryPath.get(i));

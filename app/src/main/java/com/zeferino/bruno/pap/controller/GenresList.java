...
import com.zeferino.bruno.pap.adapter.GenresAdapter;
import com.zeferino.bruno.pap.model.GenresModel;
    ...
    public void updateList() {
        if (getActivity() != null) {
            ...
            new Thread(new Runnable() {
                public void run() {
                    try {
                        request.execute(Constants.url + "genre/movie/list?&api_key=" + Constants.key).get(10000, TimeUnit.MILLISECONDS);

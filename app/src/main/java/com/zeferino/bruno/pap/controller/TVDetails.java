...
package com.zeferino.bruno.pap.controller;
...
import com.zeferino.bruno.pap.Constants;
import com.zeferino.bruno.pap.MainActivity;
import com.zeferino.bruno.pap.R;
import com.zeferino.bruno.pap.adapter.TVDetailsSlideAdapter;
import com.zeferino.bruno.pap.helper.ObservableScrollViewCallbacks;
import com.zeferino.bruno.pap.helper.ScrollState;
import com.zeferino.bruno.pap.helper.Scrollable;
import com.zeferino.bruno.pap.model.CastModel;
import com.zeferino.bruno.pap.model.SeasonModel;
import com.zeferino.bruno.pap.model.SimilarModel;
import com.zeferino.bruno.pap.view.MovieDetailsSlidingTabLayout;
import com.zeferino.bruno.pap.view.ObservableParallaxScrollView;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (currentId != this.getArguments().getInt("id") || this.timeOut == 1) {
            ...
            new Thread(new Runnable() {
                public void run() {
                    try {
                        request.execute(Constants.url + "tv/" + currentId + "?append_to_response=images,credits,similar&api_key=" + Constants.key).get(10000, TimeUnit.MILLISECONDS);
                   ...
                   /* //Season info
                    ...
                    for (int i = 0; i < seasonArray.length(); i++) {
                        ...
                        if (!object.getString("poster_path").equals("null") && !object.getString("poster_path").isEmpty())
                            season.setPosterPath(Constants.imageUrl + getResources().getString(R.string.imageSize) + object.getString("poster_path"));
                        ...
                        for (int i = 0; i < castsArray.length(); i++) {
                            ...
                            if (!object.getString("profile_path").equals("null") && !object.getString("profile_path").isEmpty())
                                cast.setProfilePath(Constants.imageUrl + getResources().getString(R.string.imageSize) + object.getString("profile_path"));
                        ...
                        if (similarLen == 0)
                            ...
                            for (int i = 0; i < similarLen; i++) {
                                ...
                                if (!object.getString("poster_path").equals("null") && !object.getString("poster_path").isEmpty())
                                    similarModel.setPosterPath(Constants.imageUrl + getResources().getString(R.string.imageSize) + object.getString("poster_path"));
    ...
    public class onGalleryIconClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (galleryList.size() == 1) {
                ...
                transaction.replace(R.id.frame_container, GalleryPreviewDetail.newInstance(Constants.imageUrl + getResources().getString(R.string.galleryPreviewImgSize) + galleryList.get(0)));

...
import com.zeferino.bruno.pap.adapter.CastAdapter;
import com.zeferino.bruno.pap.helper.ObservableListView;
    ...
    public boolean canScroll() {
        if (isAdded()) {
            ...
            if (listView.getChildAt(last) != null) {
                return !(last == listView.getCount() - 1 && listView.getChildAt(last).getBottom() <= (listView.getHeight() + (63 * getResources().getDisplayMetrics().density)));
            }
